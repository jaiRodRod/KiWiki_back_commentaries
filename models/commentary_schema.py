...
class commentary(BaseModel):
    ...
    content: str = Field(...)
    date: datetime = Field(default_factory=lambda: datetime.now(timezone(timedelta(hours=1)))) #Para que cuando se actualice el campo tome la hora actual, el timedelta sirve para declarar que la zona horaria es CEST (+2)
